...
![](04_exercisesAME1_files/figure-html/unnamed-chunk-1-1.png)<!-- -->

There seems to be more company owned stores than any other type of ownership.


Hennepin (1,279,981 residents), Ramsey (558,248), Dakota (433,302), Anoka (362,648), and Washington (262,748).
...
![](04_exercisesAME1_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
![](04_exercisesAME1_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
```
## Source : http://tile.stamen.com/watercolor/9/122/183.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/123/183.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/124/183.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/125/183.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/122/184.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/123/184.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/124/184.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/125/184.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/122/185.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/123/185.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/124/185.jpg
```

```
## Source : http://tile.stamen.com/watercolor/9/125/185.jpg
```

```r
ggmap(new_starbucks_map) +
  annotate('rect',xmin =-93.1793 , ymin=44.9340 , xmax =-93.1593 , ymax= 44.9416, color = 'red', fill = 'white' )+
  annotate('text', x=-93.25, y=45.02, label = 'Macalester College', colour = I("black"), size = 4)+
...
![](04_exercisesAME1_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
